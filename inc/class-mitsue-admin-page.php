		...
		public function field_schema(): array {
			return [
				...
				'pillars' => [
					...
					'type'    => 'repeater',
					'columns' => [ 'num' => 'Numeral', 'title_en' => 'Title EN', 'title_jp' => 'Title JP', 'body' => 'Body (separate paragraphs with |)', 'tag' => 'Footer tag' ],
					'defaults' => [
				...
				'rationale' => [
					...
					'type'    => 'repeater',
					'columns' => [ 'n' => 'Eyebrow', 'title' => 'Title', 'jp' => 'JP', 'body' => 'Body' ],
					'defaults' => [
						...
						[ 'n' => '03 · STRANDED ASSETS',   'title' => 'Closed schools as anchor facilities.',               'jp' => '廃校の利活用',         'body' => 'Closed schools currently impose net maintenance costs on shrinking municipal budgets. Productive reuse turns these into community-anchored facilities.' ],
				...
				'principles' => [
					...
					'type'    => 'repeater',
					'columns' => [ 'n' => 'Numeral', 'title' => 'Title', 'jp' => 'JP', 'body' => 'Body paragraph' ],
					'defaults' => [
