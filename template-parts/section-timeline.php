  ...
  <div class="wrap">
    <div class="section-head">
      <div class="num">§ 03<span class="label">Phased Plan</span>
        <?php $si = mitsue_get('section_img_timeline'); if ($si): ?><img src="<?php echo esc_url($si); ?>" alt="Project timeline: five phases with four gates" class="section-img" loading="lazy" decoding="async"><?php endif; ?>
      </div>
      <div>
