...
<section style="padding:0;border-bottom:1px solid var(--rule);">
  <div class="wrap" style="padding:0;">
    <div style="display:grid;grid-template-columns:2fr 1fr;min-height:480px;">
      <?php if ($img1): ?>
        <div style="background:url('<?php echo esc_url($img1); ?>') center/cover no-repeat;min-height:480px;"></div>
      <?php else: ?>
      ...
      <?php endif; ?>
      <?php if ($img2): ?>
        <div style="background:url('<?php echo esc_url($img2); ?>') center/cover no-repeat;min-height:480px;"></div>
      <?php else: ?>
