...
$items = mitsue_rows('rationale', [
  ...
  ['n'=>'02 · FOREST LIABILITY', 'title'=>'Aged cedar plantations as under-managed asset.',    'jp'=>'放置された杉人工林の活用','body'=>'Aged sugi plantations impose ecological costs — pollen burden, biodiversity loss — and physical risks: landslide and fire. Active management converts liability into timber revenue; thinning residue becomes an input to the electrical system, not a separate heat plant.','body_jp'=>'老齢化した杉の人工林は、花粉被害・生物多様性の喪失といった生態的コストと、土砂崩れ・火災リスクをもたらします。適切な管理により負の資産を木材収益へ転換し、間伐残材は独立した熱供給設備ではなく、電力系統への投入燃料として活用します。'],
