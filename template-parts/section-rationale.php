...
$items = mitsue_rows('rationale', [
  ...
  ['n'=>'03 · STRANDED ASSETS',  'title'=>'Available community facilities as anchor sites.',   'jp'=>'遊休公共施設の活用',    'body'=>'Underused community facilities such as the Mitsue Taiken Koryukan (体験交流館) currently impose net maintenance costs on shrinking municipal budgets. Productive reuse turns these into community-anchored facilities — the data center inherits a building, a community, and a story.','body_jp'=>'御杖体験交流館（体験交流館）などの遊休公共施設は現在、縮小する自治体予算に維持管理コストとして負担をかけています。有効活用することで、地域の拠点施設へと転換できます。'],
