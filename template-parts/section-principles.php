  ...
  <div class="wrap">
    <div class="section-head">
      <div class="num">§ 06<span class="label">Operating Principles</span>
        <?php $si = mitsue_get('section_img_principles'); if ($si): ?><img src="<?php echo esc_url($si); ?>" alt="The project's six guiding principles" class="section-img" loading="lazy" decoding="async"><?php endif; ?>
      </div>
      <div>
