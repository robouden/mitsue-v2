...
$lede_en     = mitsue_get('hero_lede_en', 'The Mitsue Project repurposes a closed mountain school and the forests around it into a single, transparent, openly replicable demonstration of rural revitalization — modest in scale, patient in horizon, built to be copied.');
$lede_jp     = mitsue_get('hero_lede_jp', '御杖プロジェクトは、閉校した山間の小学校とその周囲の森林を、農山村再生の透明で再現可能な統合モデルへと転換する取り組みです。');
