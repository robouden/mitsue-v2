...
$lede_en     = mitsue_get('hero_lede_en', 'The Mitsue Project repurposes the Mitsue Taiken Koryukan (体験交流館) and the forests around it into a single, transparent, openly replicable demonstration of rural revitalization — modest in scale, patient in horizon, built to be copied.');
$lede_jp     = mitsue_get('hero_lede_jp', '御杖プロジェクトは、御杖体験交流館とその周囲の森林を、農山村再生の透明で再現可能な統合モデルへと転換する取り組みです。');
