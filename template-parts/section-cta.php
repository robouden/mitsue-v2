  ...
  <div class="wrap">
    <div class="grid">
      <div>
        ...
        <p>The project is currently in pre-foundation phase. We're identifying patient capital, advisory partners, and Japanese co-founders with rural credibility. If your time horizon matches ours, we would welcome the conversation.</p>
        <div class="actions">
