  ...
  <div class="wrap">
    <div class="section-head">
      <div class="num">§ 05<span class="label">Funding</span>
        <?php $si = mitsue_get('section_img_funding'); if ($si): ?><img src="<?php echo esc_url($si); ?>" alt="Five-layer funding stack diagram" class="section-img" loading="lazy" decoding="async"><?php endif; ?>
      </div>
      <div>
