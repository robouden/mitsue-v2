...
<section class="hero" style="border-bottom:1px solid var(--rule);">
  <div class="wrap">
    <div class="mono" style="color:var(--ink-mute);margin-bottom:18px;"><?php echo esc_html( mitsue_get('join_eyebrow', 'Careers · 御杖村森林組合 × Mitsue Project') ); ?></div>
    ...
    <p class="body-en" style="max-width:56ch;color:var(--ink-soft);font-size:17px;line-height:1.7;"><?php echo esc_html( mitsue_get('join_lede_en', '') ); ?></p>
    <p class="body-jp jp" style="max-width:60ch;color:var(--ink-soft);font-size:17px;line-height:1.9;"><?php echo esc_html( mitsue_get('join_lede_jp', '') ); ?></p>
  </div>
</section>
  ...
  <div class="wrap">
    <div class="section-head">
      ...
      <div>
        ...
        <div class="h2-sub body-en"><?php echo esc_html( mitsue_get('join_work_intro_en', '') ); ?></div>
        <div class="h2-sub body-jp jp"><?php echo esc_html( mitsue_get('join_work_intro_jp', '') ); ?></div>
      </div>
    </div>
    <div class="pillars">
...
<section style="background:var(--paper-2, #f7f6f2);border-top:1px solid var(--rule);">
  <div class="wrap">
    ...
    <p style="margin-top:18px;color:var(--ink-mute);font-size:14px;">
      <span class="body-en"><?php echo esc_html( mitsue_get('join_stack_note_en', '') ); ?></span>
      <span class="body-jp jp"><?php echo esc_html( mitsue_get('join_stack_note_jp', '') ); ?></span>
    </p>
  </div>
</section>
...
<section class="cta" id="contact">
  <div class="wrap">
    ...
    <p style="max-width:52ch;margin:10px auto 24px;">
      <span class="body-en"><?php echo esc_html( mitsue_get('join_cta_body_en', '') ); ?></span>
      <span class="body-jp jp"><?php echo esc_html( mitsue_get('join_cta_body_jp', '') ); ?></span>
    </p>
    <div class="cta-contact-row">
      <a class="cta-btn" href="mailto:<?php echo esc_attr( antispambot( $email ) ); ?>?subject=Join%20Mitsue%20%E2%80%94%20Reforest%20/%20Power%20/%20Revive">
